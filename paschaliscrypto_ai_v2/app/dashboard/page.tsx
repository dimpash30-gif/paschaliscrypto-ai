...
export default function Dashboard(){
 ...
 async function load(){
  ...
  try{
   ...
   setMarket(j.market || [])
   setMsg(`Βρέθηκαν ${j.count || 0} κρυπτονομίσματα με ζωντανά market data.`)
  }catch(e:any){
 ...
 return <>
 <header className="top"><div className="brand"><TrendingUp/> PaschalisCrypto AI <span className="tag">Live Market Beta</span></div><button onClick={logout} className="btn"><LogOut size={16}/> Έξοδος</button></header>
 <main className="wrap">
  ...
  {tab==='About'&&<section className="card"><h2>About PaschalisCrypto AI</h2><p>Η έκδοση αυτή κάνει αναζήτηση 50 κρυπτονομισμάτων και εμφανίζει ζωντανές τιμές/μεταβολές από public market data.</p><p>Το επόμενο βήμα είναι να προσθέσουμε πραγματικούς δείκτες RSI, MACD, ADX και ATR όπως στον Python scanner σου.</p><div className="notice">Τα σήματα είναι εκπαιδευτικά/βοηθητικά και όχι οικονομική συμβουλή.</div></section>}
 </main></>
}
